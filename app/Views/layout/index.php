        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu Tukang Cukur:</h6>
                        <a class="collapse-item" href="<?= base_url('tukangcukur/booking/tampil') ?>">Kelola Booking</a>
                        <a class="collapse-item" href="<?= base_url('tukangcukur/profil/tampil') ?>">Kelola Profil</a>
                    </div>
                </div>
            </li>
